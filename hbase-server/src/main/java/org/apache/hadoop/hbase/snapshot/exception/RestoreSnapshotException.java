...
public class RestoreSnapshotException extends HBaseSnapshotException {
  ...
  public RestoreSnapshotException(String msg, Throwable cause) {
    super(msg, cause);
  }
  ...
  public RestoreSnapshotException(Throwable cause, SnapshotDescription desc) {
    super(cause, desc);
  }

  public RestoreSnapshotException(Throwable cause) {
    super(cause);
  }
}
