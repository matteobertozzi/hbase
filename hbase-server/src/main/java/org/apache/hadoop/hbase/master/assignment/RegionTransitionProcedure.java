 ...
 *
 * This procedure is asynchronous and respond to external events.
...
public abstract class RegionTransitionProcedure
  ...
  public boolean isMeta() {
    return getTableName().equals(TableName.META_TABLE_NAME);
  }
  ...
  protected Procedure[] execute(final MasterProcedureEnv env) throws ProcedureSuspendedException {
    ...
    final RegionStateNode regionNode = getRegionState(env);
    LOG.debug("Transition " + transitionState + ": " + this);
    ...
    try {
      ...
      LOG.warn("Retriable error trying to transition: " + regionNode, e);
    }
