 ...
 *
 * The Unssign starts by placing a "close region" request in the Remote Dispatcher
 * queue, and the procedure will go in a "waiting state".
 ...
 * The procedure will finish the unassign by publishing to new state on meta
 * or it will retry the unassign.
 */
@InterfaceAudience.Private
public class UnassignRegionProcedure extends RegionTransitionProcedure {
  private static final Log LOG = LogFactory.getLog(UnassignRegionProcedure.class);
  ...
  public UnassignRegionProcedure() {
    // Required by the Procedure framework to create the procedure on replay
  }

  public UnassignRegionProcedure(final HRegionInfo regionInfo,
