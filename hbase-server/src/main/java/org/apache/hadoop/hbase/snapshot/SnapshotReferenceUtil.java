...
public final class SnapshotReferenceUtil {
  ...
  public static Path getRecoveredEditsDir(Path snapshotDir, String regionName) {
    return new Path(snapshotDir, new Path(regionName, HLog.RECOVERED_EDITS_DIR));
  }
   ...
   * @throws IOException if a error occurred while scanning the directory
   */
  public static void listReferencedFiles(final FileSystem fs, final Path snapshotDir,
    ...
    listTableStoreFiles(fs, snapshotDir, visitor);
   ...
   * @throws IOException if a error occurred while scanning the directory
   */
  public static void listTableStoreFiles(final FileSystem fs, final Path snapshotDir,
   ...
   * NOTE: The current implementation keep one empty file per HFile in the region.
   *
   * @param fs {@link FileSystem}
  ...
  public static Map<String, List<String>> getRegionHFileReferences(final FileSystem fs,
    ...
    listRegionStoreFiles(fs, snapshotRegionDir,
  ...
  public static Set<String> getHFileNames(final FileSystem fs, final Path snapshotDir) throws IOException {
    ...
    listTableStoreFiles(fs, snapshotDir, new FSVisitor.StoreFileVisitor() {
      public void storeFile (final String region, final String family, final String hfile)
          throws IOException {
        names.add(hfile);
      }
