 ...
 * </pre>
 * 
 * Utility methods in this class are useful for to getting the correct locations for different parts
 * of the snapshot, as well as moving completed snapshots into place (see
