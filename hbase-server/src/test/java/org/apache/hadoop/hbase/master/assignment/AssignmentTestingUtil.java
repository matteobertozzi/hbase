...
public abstract class AssignmentTestingUtil {
  ...
  public static ServerName getServer(final HBaseTestingUtility util, final TableName tableName,
      final boolean carryingMeta) throws Exception {
    ...
    fail("unexpected state, no server found for carryingMeta="+ carryingMeta +" table="+ tableName);
    return null;
  }
